...
<div>
  <div class="top-menu">
    <div
      class={ui.openScreen === Screen.World || ui.openScreen === Screen.Region
        ? "selected"
        : ""}
    ...
    <div
      class={ui.openScreen === Screen.Characters ? "selected" : ""}
      on:click={() => ($State.ui.openScreen = Screen.Characters)}
    >
      PERSOS
    </div>
    <div
      class={ui.openScreen === Screen.Items ? "selected" : ""}
      on:click={() => ($State.ui.openScreen = Screen.Items)}
    >
      OBJETS
    </div>
  </div>
